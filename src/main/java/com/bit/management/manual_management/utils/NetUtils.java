package com.bit.management.manual_management.utils;
...
public class NetUtils {
   ...
   * @return
   */
  public static boolean pingIpAddress(Fileserver fileserver) {
    try {
      Process process = Runtime.getRuntime().exec("/system/bin/ping -c 1 -w 100 " + fileserver.getIp().trim());
   ...
   * @throws IOException
   */
  public boolean connect(Fileserver fileserver, String username, String password) throws Exception {
    try {
      ftpClient.connect("10.55.223.210",21);
      System.out.println("hah");
      ftpClient.connect(fileserver.getIp().trim(), fileserver.getPort());
    } catch (Exception e) {
      e.printStackTrace();
    }
